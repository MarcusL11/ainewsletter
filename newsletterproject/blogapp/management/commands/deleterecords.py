...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        model_names_input = input("Enter the model names separated by commas (or 'all_models' for all models)  Available models are BlogPost, Tag and TableOfContent : ")
        if model_names_input.lower() == 'all_models':
            model_names = ['BlogPost', 'Tag', 'TableOfContent']
        else:
