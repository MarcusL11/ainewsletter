from crewai import Agent  # noqa: I001
...
class AINewsLetterAgents():
    def editor_agent(self):
        return Agent(
            ...
            not only informs but also engages and inspires the readers. """,  # noqa: E501
    ...
    def news_fetcher_agent(self):
        return Agent(
            ...
            in the world of AI, ensuring that our readers are always in the know.""",# noqa: E501
    ...
    def news_analyzer_agent(self):
        return Agent(
            ...
            analyses of AI news stories, making them accessible and engaging for our audience.""",# noqa: E501
            tools=[SearchTools.search_internet],
            verbose=True,
            allow_delegation=True,
        )
    ...
    def newsletter_compiler_agent(self):
        return Agent(
            ...
            newsletter format guidelines and maintain consistency throughout.""",# noqa: E501
            verbose=True,
        )
